...
function rnkrwp_menu(){
	...
	//Setup menus
	$rnkrwp_options		= add_options_page( __( 'Ranker Polling Widget - Options', 'rnkrwp' ), __( 'Ranker Widget', 'rnkrwp' ), 'manage_options', 'rnkrwp-options', 'rnkrwp_plugin_options' );
	$rnkrwp_shortcodes	= add_management_page( __( 'Ranker Polling Widget - Shortcodes', 'rnkrwp' ), __( 'Ranker Shortcodes', 'rnkrwp' ), 'manage_options', 'rnkrwp-shortcodes', 'rnkrwp_plugin_shortcodes' );
	//Add resources
